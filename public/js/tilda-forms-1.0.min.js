        ...
        if ((v.length && !E || E && A) && (n = !1), u && (b || E && !A)) w.type.push("req");
          ...
          switch (d) {
            case "email":
              ...
              break;
            case "url":
              if (m = /^((https?|ftp):\/\/)?[a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéûşç0-9xn\-][a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéûşç0-9_\.\-]{0,253}\.[a-zA-Zёа-яЁА-Я\-0-9]{2,11}\/?$/gi, v.length)
                if ((f = (f = (f = v.split("//")) && f.length > 1 ? f[1] : f[0]).split("/")) && f.length && f[0]) {
                  if (!(f = f[0]).match(m)) {
                    var L = /^[a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéûşç0-9]([a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéûşç0-9_\-]|xn--)*(\.[a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéûşç0-9\-]{2,})+$/i;
            ...
            case "phone":
              var I = c.getAttribute("data-tilda-mask"),
                j = "^[0-9()+-";
              I && (-1 !== I.indexOf("*") ? j += "a-zёа-я" : (-1 !== I.indexOf("a") && (j += "a-z"), -1 !== I.indexOf("а") && (j += "а-яё"))), j += "]+$", m = new RegExp(j, "gi"), (h.length && !h.match(m) || 1 == (f = h.replace(/[^0-9]+/g, "")).indexOf("000") || 1 == f.indexOf("111") && "9" != f.substring(0, 1) || 1 == f.indexOf("222") && "5" != f.substring(0, 1) || 1 == f.indexOf("333") || 1 == f.indexOf("444") || 1 == f.indexOf("5555") && "0" != f.substring(0, 1) || 1 == f.indexOf("666") && "0" != f.substring(0, 1) || 1 == f.indexOf("8888") && "4" != f.substring(0, 1)) && w.type.push("phone");
              break;
            case "number":
...
function t_forms__onSuccess(t) {
  ...
  if (m > window.scrollY || v - u < _ - 100) A || n.classList.add(g), _ > v && E && setTimeout((function() {
    t_fadeOut(E)
  }), 300);
  else {
