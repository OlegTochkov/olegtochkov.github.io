...
function t_form_phonemask_init(e, t, n, a) {
  ...
  if (s && "undefined" !== s) i(e, t, s);
    ...
    m.open("GET", "https://geo.tildaapi." + c + "/geo/country/", !0), m.onreadystatechange = function() {
      if (4 === m.readyState)
        if (m.status >= 200 && m.status < 400) {
          ...
          var a, o = Object.keys(t_form_phonemask__getCountriesList()),
...
function t_form_phonemask__prepareInputGroup(e) {
  ...
  if (s) {
    ...
    l.setAttribute("data-phonemask-flag", p), d.innerHTML = c, t_form_phonemask__changeMinLength(u, c, t), t_form_phonemask__addCurrentStyle(t), t_form_phonemask__initSelectEvents(o, t, r)
  }
}
...
function t_form_phonemask__initSelectEvents(e, t, n) {
  var a = 1,
    ...
    r = document.querySelector(".t-input-phonemask__options-wrap"),
    i = e.querySelector(".t396__artboard"),
    s = document.querySelector(".t-popup"),
    m = "",
    c = "";
  ...
  function l() {
    r.innerHTML = t_form_phonemask__getDrawSelector(n)
  }

  function d() {
    var e = r.querySelectorAll(".t-input-phonemask__options-item");
  ...
  function _() {
    var e = t.getBoundingClientRect(),
      ...
      o = e.height,
      p = e.width,
      i, s = r.getBoundingClientRect().width,
      m = document.documentElement.clientWidth,
      c;
    if (s + a < m) r.style.right = "unset", r.style.left = a + "px";
    else {
      var u = a + p;
      r.style.left = "unset", r.style.right = m - u + "px"
    }
    r.style.top = n + o + 5 + "px"
  }

  function x() {
    if (!i) return 1;
    var e, t = "ab" + i.getAttribute("data-artboard-recid"),
      n;
    return (window.tn && window.tn[t] ? window.tn[t].scaleFactor : window.tn_scale_factor) || 1
  }
  ...
  function h() {
    var e = t.getBoundingClientRect(),
      ...
      o = e.height,
      p = e.width,
      i, s = document.body.getBoundingClientRect().top,
      m, c = r.getBoundingClientRect().width,
      u = document.documentElement.clientWidth,
      l = x(),
      d = a * l,
      _ = p * l,
      h;
    if (r.style.position = "absolute", c + d < u) r.style.right = "unset", r.style.left = d + "px";
    else {
      var k = d + _;
      r.style.left = "unset", r.style.right = u - k + "px"
    }
    r.style.top = (n - s + o) * l + 5 + "px"
  }
  ...
  function f() {
    window.addEventListener("resize", g), document.addEventListener("scroll", g), s && s.addEventListener("scroll", g)
  }

  function b() {
    window.removeEventListener("resize", g), document.removeEventListener("scroll", g), s && s.removeEventListener("scroll", g)
  }

  function y() {
    l(), _(), d(), b(), k() ? h() : (r.style.position = "", f())
  }

  function v() {
    r.classList.contains("t-input-phonemask__options-wrap_open") ? w() : (w(), r.classList.add("t-input-phonemask__options-wrap_open"), y())
  }

  function w() {
    var e = document.querySelector(".t-input-phonemask__options-wrap_open");
    e && e.classList.remove("t-input-phonemask__options-wrap_open"), b()
  }
  ...
  function C() {
    t_form_phonemask__chooseCountry(t, this), w()
  }
  ...
  function L(e) {
    ...
    if (t) {
      ...
      if (r || i) {
        ...
        if (c && n[c]) t_form_phonemask__searchCountry(t, m, p, c, n[c].c);
        else
          for (var l in n) t_form_phonemask__searchCountry(t, m, p, l, n[l].c);
        return t_form_phonemask__scrollToCountry(t, p), void u()
      }
      var d = /^[a-zA-Z]$/.test(e.key),
        _ = /^[а-яА-Я]$/.test(e.key);
      if (d || _) {
        m = (m += e.key).replace(a, "\\$&");
        var x = new RegExp("(^|\\()" + m, "i");
        for (var h in n) t_form_phonemask__searchCountry(t, x, p, h, n[h].n);
        t_form_phonemask__scrollToCountry(t, p), u()
      }
    }
  }
  t_form_phonemask__changeVal(t, o), p.addEventListener("click", v), o.addEventListener("paste", (function(e) {
    var t = (e.clipboardData || window.clipboardData).getData("text");
    if (t) {
      t = t.replace(/[^0-9+]/g, "");
      var n = e.target;
      n && (n.value = t, S.call(n), n.dispatchEvent(new Event("change", {
        bubbles: !0
      })), e.preventDefault())
    }
  })), o.addEventListener("input", S), document.addEventListener("mouseup", A), document.addEventListener("keyup", L), document.querySelector('[data-init-mask="yes"]') || (document.addEventListener("mouseup", A), document.addEventListener("keyup", L))
}
...
function t_form_phonemask__addNumberMask(e, t) {
  var n = t.getAttribute("data-phonemask-code"),
    ...
    i = "";
  if (r) {
    for (var s = 0; s < r.length; s++) "0" === r[s][0] ? (i += p.slice(0, r[s].length).join(""), p.splice(0, r[s].length)) : i += r[s];
...
function t_form_phonemask__setValue(e, t, n, a) {
  if (e) {
    ...
    if (o) {
      ...
      d && (d.value = t_form_phonemask__removeCountryCodeFromValue(t, u.c), t_form_phonemask__handleChangeInputValue(e, d))
    }
  }
}
...
function t_form_phonemask__handleUpdateCountry(e, t) {
  ...
  i.setAttribute("placeholder", u), t_form_phonemask__calcMaxlength(i), s.innerHTML = n, m.setAttribute("data-phonemask-flag", o);
  try {
...
function t_form_phonemask__handleChangeInputValue(e, t) {
  ...
  var a = t.getAttribute("data-phonemask-code"),
    ...
    r;
  o && p && (t.value = n.replace(/^.(8|7)9/, "9")), ["+373", "+380", "+33"].includes(a) && n.startsWith("0") && (t.value = n.replace(/^0/, "")), t_form_phonemask__addNumberMask(t_form_phonemask__copypasteHandling(t, t.getAttribute("data-phonemask-without-code")), t), t_form_phonemask__changeVal(e, t), t.setAttribute("data-phonemask-current", t.value)
}
