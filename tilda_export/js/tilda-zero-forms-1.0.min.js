...
function t396__setOverflowToAllRecords() {
  ...
  if (t) {
    ...
    t.classList.remove("t-records__overflow-clip", "t-records__overflow-hidden"), t.classList.add(r ? "t-records__overflow-clip" : "t-records__overflow-hidden")
  }
}
...
function t396__getArtboards(t) {
  var e = document.getElementById("allrecords"),
    r, o = e && "edit" === e.getAttribute("data-tilda-mode") ? '.record[data-record-type="' + t + '"] .r:not(.t397__off, .t395__off, .t400__off) .t396__artboard, .record[data-parenttplid="' + t + '"] .r:not(.t397__off, .t395__off, .t400__off) .t396__artboard' : '.r[data-record-type="' + t + '"]:not(.t397__off, .t395__off, .t400__off) .t396__artboard, .r[data-parenttplid="' + t + '"]:not(.t397__off, .t395__off, .t400__off) .t396__artboard';
...
function t396_elem__getFormInputsValue(t) {
  ...
  if (e) {
    ...
    if (r) try {
      ...
      return console.error("Error parsing form inputs textarea value:", i, r), []
    }
  }
...
if (window.t_zeroForms__browserLang = (window.navigator.userLanguage || window.navigator.language).toUpperCase().slice(0, 2), window.t_zeroForms__isMobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent), window.t_zeroForms__isSafari = /^((?!chrome|android).)*safari/i.test(navigator.userAgent), window.t_zeroForms__isiOS = /iPhone|iPad|iPod/i.test(navigator.userAgent), window.t_zeroForms__iOSMajorVersion = "", window.t_zeroForms__isiOS) {
...
function t_zeroForms__init(t, e, r) {
  ...
  if (i && document.contains(i)) {
    ...
    t_zeroForms__waitForTN((function() {
      document.contains(i) && (t_zeroForms__renderForm(i, r, t, a), t_zeroForms__waitForResources(t).then((function() {
        t396_elem__renderViewOneField(s ? $(i) : i, "left"), t396_elem__renderViewOneField(s ? $(i) : i, "top")
      })))
    }))
  }
}
...
function t_zeroForms__renderForm(t, e, r, o) {
  t = t_zeroForms__getEl(t), o || (o = t_zeroForms__getTildaMode()), r || (r = t_zeroForms__getRecID(t));
  var n = document.querySelector(".t-records"),
    i = !!n && "edit" === n.getAttribute("data-tilda-mode"),
    a;
  if ((i || (i = "published" !== o), !t.classList.contains("zero-form-rendered") || i) && ("published" === o && t396_zeroForms__setBrowsersInfo(), !t_zeroForms__isRecordHidden(t.closest(".r")) && !t_zeroForms__isFormOutside(t) || "published" !== o)) {
    ...
    if (_) {
      l.insertAdjacentElement("beforeend", _), t_zeroForms__placeFormIntoColumns(t);
...
function t_zeroForms__prepareFormsIds() {
  try {
    ...
    var t, e = t396__getZeroBlocks().map((function(t) {
      var e = t.record,
        r = t.artboard,
...
function t_zeroForms__prepareFormIds__buildFormsIdsMap(t, e) {
  ...
  })).filter(Boolean).sort().reduce((function(e, r, o) {
    return e[r] = 0 === o ? "form" + t : "form" + t + "_" + r, e
  }), {})
}

function t_zeroForm__prepareFormIds__editor() {
  var t, e, r = window.tn ? window.tn.artboard_id : null == (t = document.querySelector(".tn-artboard")) ? void 0 : t.getAttribute("data-record-id"),
    o = Array.from(document.querySelectorAll('.tn-elem[data-elem-type="form"]'));
  o.length && r && (window.t_zeroForms__formIdMap = ((e = {})[r] = t_zeroForms__prepareFormIds__buildFormsIdsMap(r, o), e))
}

function t_zeroForms__getFormId(t, e) {
  var r = "form" + t;
  try {
    return t_zeroForms__getFormId__isOpenForRec(t) ? (t_zeroForms__prepareFormsIds(), window.t_zeroForms__formIdMap[t][e] || r) : r
  } catch (o) {
    return r
  }
}
...
function t_zeroForms__createForm(t, e, r, o) {
  ...
  m.classList.add("js-successbox"), m.classList.add("t-form__successbox"), m.classList.add("t-text"), m.classList.add("t-text_sm"), m.style.display = "none", m.innerHTML = n.formmsgsuccess, s.insertAdjacentElement("beforeend", m);
  var p = {
  ...
  if (b) {
    ...
    v.style.textAlign = "center" === n.buttonalign ? "center" : "left", v.style.color = p.color, v.style.fontWeight = p.fontWeight, v.style.fontFamily = p.fontFamily, v.style.marginTop = "15px", v.style.fontSize = "13px";
    var F = t_zeroForms__getBottomText(l, n, t, o, b);
    v.appendChild(F), s.insertAdjacentElement("beforeend", v)
  }
  if (s.insertAdjacentElement("beforeend", t_zeroForms__createErrorBox(t, n, "bottom")), s.insertAdjacentElement("beforeend", t_zeroForms__createCommentField()), t_zeroForms__createInputPlaceholderStyles(l, n, t, o), "h" === n.inputpos || "zero" === e) {
    ...
    y && y.addEventListener("load", (function() {
  ...
  t_zeroForms__addInlineTag({
    ...
    zeroForm: o
  }), "y" === n.inputsstyle2 && t_zeroForms__onRender(o, !1, (function() {
  ...
  if (n.fieldfontfamily) {
    var w = t_zeroForms__createSelector(t, l, ""),
      x = ['input[type="text"]', 'input[type="tel"]', 'input[type="url"]', 'input[type="email"]', ".t-input-phonemask__select", "textarea", "select", ".t-input__vis-ph"],
      A;
    x = x.reduce((function(t, e, r) {
      ...
      tag: "style",
      id: h,
      content: A = /var\(/.test(n.fieldfontfamily) ? x + " {font-family: " + n.fieldfontfamily + ";}" : x + ' {font-family: "' + n.fieldfontfamily + '";}',
      zeroForm: o
    })
  } else {
  ...
  return window.addEventListener(S, (function() {
    I || (I = setTimeout((function() {
      t_zeroForms__updateCurrentResolution(t, k), t_zeroForms__updateStylesOnResize(t, o), clearTimeout(I), I = 0
    }), 600))
  })), s
}
...
function t_zeroForms__updateStylesOnResize(t, e) {
  ...
  if (Array.prototype.forEach.call(a, (function(t) {
    ...
    n && n.classList.add("tn-form_horiz"), t_zeroForms__addResource({
      recId: t,
...
function t_zeroForms__updateTopPosition(t) {
  var e;
  void 0 !== window.t396_elem__getFieldValue && void 0 !== window.t396_elem__renderViewOneField && (document.contains(t) && "top" !== t396_elem__getFieldValue(t, "axisy") && t396_elem__renderViewOneField(t, "top"))
}
...
function t_zeroForms__generateInputsBlock(t, e, r, o, n) {
  ...
  return s.classList.add("t-form__inputsbox"), (a = t396_zeroForms__markElementsUsedInCalculator(a)).forEach((function(r) {
    var a = t_zeroForms__parseIntoElement(t, e, r, o, n, i);
    a && s.insertAdjacentElement("beforeend", a)
  })), s.insertAdjacentElement("beforeend", t_zeroForms__createErrorBox(t, o, "middle")), s.insertAdjacentElement("beforeend", t_zeroForms__createFormButton(t, e, i, o)), s
}
...
function t_zeroForms__parseIntoElement(t, e, r, o, n, i) {
  ...
  s.classList.add("t-input-group"), s.classList.add("t-input-group_" + r.li_type), s.setAttribute("data-input-lid", r.lid), s.setAttribute("data-field-type", r.li_type), s.setAttribute("data-field-name", r.li_nm);
  ...
  switch (f.classList.add("t-input-block"), r.li_type) {
    case "em":
      ...
      break;
    case "ph":
      b = t_zeroForms__createPhoneInput(t, r, u, p), "a" === r.li_masktype && (t_zeroForms__addResource({
        recId: t,
        id: "t-zero-phonemask",
    ...
    case "rd":
      ...
      s.setAttribute("data-field-radcb", r.li_radcb), b = t_zeroForms__createRadio(r, o, p, m, y, t, i), t_zeroForms__setIndicatorStyles(t, i, o.inputelscolor, y, b);
      var h = t ? "#rec" + t + " " : "";
      t_zeroForms__addInlineTag({
        tag: "style",
        ...
        zeroForm: e
      }), "checkbox" === y && t_zeroForms__onRender(e, !1, (function() {
      ...
      break;
    case "ri":
      b = t_zeroForms__createRadioImage(r, o, p), s.setAttribute("data-field-radcb", r.li_radcb), t_zeroForms__setIndicatorStyles(t, i, o.inputelscolor, "img-select", b), t_zeroForms__addResource({
        recId: t,
      ...
      break;
    case "cb":
      b = t_zeroForms__createCheckbox(r, m, o, p), t_zeroForms__setIndicatorStyles(t, i, o.inputelscolor, "checkbox", b);
      break;
    case "uw":
      b = t_zeroForms__createUploadField(t, r, p, "uw"), "published" === window.tildamode && t_zeroForms__onRender(e, !0, (function() {
    ...
    case "uc":
      ...
      break;
    case "da":
      b = t_zeroForms__createDateField(t, r, p, u, o), t_zeroForms__onRender(e, !0, (function() {
    ...
    case "tm":
      ...
      break;
    case "qn":
      b = t_zeroForms__createQuantityField(r, u, o.inputelscolor, p), e.removeEventListener("click", t_zeroForms__initQuanityClickCount), e.addEventListener("click", t_zeroForms__initQuanityClickCount);
      break;
    case "rg":
    ...
    case "ur":
      ...
      break;
    case "tx":
      (b = document.createElement("div")).classList.add("t-text"), b.setAttribute("field", "li_text__" + r.lid), b.style.fontWeight = m.fontWeight, b.style.fontSize = m.fontSize + "px", b.style.fontFamily = n.fontFamily, b.style.color = n.color, b.innerHTML = r.li_text || "";
      break;
    case "ws":
    ...
    case "fr":
      if (b = t_zeroForms__createCalculation(t, r, u, p, n), o.inputfrbgcolor) {
        ...
        S.textContent = k + "{background-color:" + o.inputfrbgcolor + "; padding: 20px 30px 25px;}", b.insertAdjacentElement("beforeend", S)
      }
      t_zeroForms__onRender(e, !1, (function() {
  ...
  if (I.classList.add("t-input-error"), f.insertAdjacentElement("beforeend", I), s.insertAdjacentElement("beforeend", f), "h" !== o.inputpos) {
    var j = r.li_type;
    "em" !== j && "ph" !== j && "nm" !== j && "in" !== j && "ta" !== j && "sb" !== j && "cb" !== j && "uw" !== j && "da" !== j && "tm" !== j && "qn" !== j && "rg" !== j && "ur" !== j && "tx" !== j || t_zeroForms__setFieldsRowClasses(p, s), "rd" === r.li_type && t_zeroForms__setRadioRowClasses(p, f)
  }
  return s
}
...
function t_zeroForms__generateSubtitle(t, e, r) {
  ...
  "LABEL" === i.tagName && (i.style.display = "block"), "LABEL" === i.tagName && i.setAttribute("for", t.li_type + "-" + t.lid), i.classList.add("t-input-subtitle"), i.classList.add("t-descr"), i.classList.add("t-descr_xxs"), i.classList.add("t-opacity_70"), i.setAttribute("field", "nullli_subtitle__" + t.lid), t_zeroForms__setTitleStyles(i, e, ""), i.innerHTML = t.li_subtitle, r.insertAdjacentElement("beforeend", i)
}
...
function t_zeroForms__generateTitle(t, e, r, o) {
  ...
  "LABEL" === a.tagName && (a.style.display = "block"), "LABEL" === a.tagName && a.setAttribute("for", t.li_type + "-" + t.lid), a.classList.add("t-input-title"), a.setAttribute("data-redactor-toolbar", "no"), a.setAttribute("field", "nullli_title__" + t.lid), t_zeroForms__setTitleStyles(a, e, o), a.innerHTML = t.li_title, r.insertAdjacentElement("beforeend", a)
}

function t_zeroForms__createPhoneInput(t, e, r, o) {
  var n = e.li_masktype,
    i = document.createElement("input");
  if (e.li_title || e.li_subtitle ? i.id = e.li_type + "-" + e.lid : i.ariaLabel = "phone", t_zeroForms__appendMainSettingToField(i, o, "tel", ""), "a" === n ? i.classList.add("js-phonemask-input") : e.li_mask && i.classList.add("js-tilda-mask"), "a" === n) {
    var a = "RU" === window.t_zeroForms__browserLang ? "+7" : "+1";
    i.placeholder = a + "(000)000-0000", i.setAttribute("data-phonemask-init", "no"), i.setAttribute("data-phonemask-id", t), i.setAttribute("data-phonemask-lid", e.lid), e.li_maskcountry && i.setAttribute("data-phonemask-maskcountry", e.li_maskcountry), o.secondaryClassName && i.classList.add(o.secondaryClassName), o.require && i.setAttribute("data-tilda-req", "1")
...
function t_zeroForms__createSelect(t, e, r, o) {
  ...
  s.id = t.li_type + "-" + t.lid, t_zeroForms__appendMainSettingToField(s, r, "", "t-select"), r.secondaryClassName && s.classList.add("t-select_bbonly"), r.require && s.setAttribute("data-tilda-req", "1"), t_zeroForms__appendStylesToField(s, e);
  var l = e && e.color && !o;
  if (t.li_selfirstvar) {
    var _ = document.createElement("option");
    _.innerHTML = t.li_selfirstvar, _.setAttribute("value", ""), l && (_.style.color = e.color), s.insertAdjacentElement("beforeend", _)
  }
  var l = e && e.color && !o;
  return n.forEach((function(r, o) {
    var n = document.createElement("option"),
      ...
      _ = a.label,
      d = a.calcValue;
    d && t396_zeroForms__setCalcValue(n, d), n.value = _, n.innerHTML = _, l && (n.style.color = e.color), i && i === o + 1 && (n.selected = !0), s.insertAdjacentElement("beforeend", n)
...
function t_zeroForms__createRadio(t, e, r, o, n, i, a) {
  ...
  return s.forEach((function(s, l) {
    ...
    if (h.innerHTML = g, u.insertAdjacentElement("beforeend", h), s === t.li_ownvariant) {
  ...
  })), l && t.li_ownvariant && t_zeroForms__updateOwnAnswerVisibility(f, p), c
}
...
function t_zeroForms__createRadioImage(t, e, r) {
  ...
  if (n) {
    ...
    t.li_imgs_in_row_mob ? l.classList.add("t-img-select__container__mobile_" + t.li_imgs_in_row_mob + "-in-row") : e.shouldUseTwoColumnRadioImg && l.classList.add("t-img-select__container__mobile_2-in-row"), t.li_imgs_in_row && l.classList.add("t-img-select__container_" + t.li_imgs_in_row + "-in-row"), l.setAttribute("data-check-bgcolor", e.inputelscolor || "#000"), o && s.appendChild(t_zeroForms__createNameFieldForCheckbox(r, l, "img-select")), s.appendChild(l);
    var _ = o ? "checkbox" : "radio",
      d, c = "t-img-select__indicator_" + (t.li_imgratio ? t.li_imgratio.replace("_", "-") : "1-1");
    return i.forEach((function(n, i) {
      var s = t_zeroForms__createLabel("img-select", "", !1),
        ...
        m = u.label,
        p = u.calcValue;
      p && t396_zeroForms__setCalcValue(d, p), d.type = _, d.value = m || n.img, d.classList.add("t-img-select"), o || (d.name = t.li_nm), o || d.classList.add("js-tilda-rule"), a && a === i + 1 && (d.checked = !0), r.require && d.setAttribute("data-tilda-req", "1"), s.insertAdjacentElement("beforeend", d);
      var f = t_zeroForms__createIndicator("img-select", !1, {
        ratio: c,
        img: n.img
      });
      if (f.classList.add("t-bgimg"), f.classList.add("t-img-select__indicator"), t.li_img_fill_mode && f.classList.add("t-img-select__indicator_fillmode-" + t.li_img_fill_mode), e.inputtitlecolor && (f.style.borderColor = t_zeroForms__fromHEXtoRGBA(e.inputtitlecolor, .1)), f.classList.add(c), f.setAttribute("data-original", n.img), f.style.backgroundImage = 'url("' + n.img + '")', s.insertAdjacentElement("beforeend", f), m) {
        var b = document.createElement("div");
        b.classList.add("t-img-select__text"), b.classList.add("t-text"), b.classList.add("t-text_xs"), b.innerHTML = m, e.inputtitlecolor && (b.style.color = e.inputtitlecolor), s.insertAdjacentElement("beforeend", b)
      }
...
function t_zeroForms__createUploadField(t, e, r, o) {
  ...
  return "uploadcare-3.x.min.js" !== u || window.jQuery || (u = "uploadcare-3.x.full.min.js"), (n || !n && !document.querySelector('script[src*="uploadcare-3.x"]')) && t_zeroForms__addResource({
    recId: t,
    id: l + "-zero-form",
    path: u,
    type: "script"
...
function t_zeroForms__createDateField(t, e, r, o, n) {
  var i = t_zeroForms__createWrapper("t-datepicker__wrapper"),
    ...
    s = (e.li_dateUnavailPast ? "past," : "") + (e.li_dateUnavailMo ? "mo," : "") + (e.li_dateUnavailTu ? "tu," : "") + (e.li_dateUnavailWe ? "we," : "") + (e.li_dateUnavailTh ? "th," : "") + (e.li_dateUnavailFr ? "fr," : "") + (e.li_dateUnavailSa ? "sa," : "") + (e.li_dateUnavailSu ? "su," : "") + (e.li_dateUnavailFuture ? "future," : "") + (e.li_dateUnavailToday ? "today," : "");
  s.length && "," === s[s.length - 1] && (s = s.slice(0, -1)), t_zeroForms__appendMainSettingToField(a, r, "text", ["t-input", "t-datepicker", "js-tilda-mask"]), t_zeroForms__appendAttributes(a, r), t_zeroForms__appendStylesToField(a, o), a.setAttribute("data-tilda-rule", "date"), a.setAttribute("data-tilda-dateformat", e.li_dateformat), a.setAttribute("data-tilda-datediv", e.li_datediv), a.setAttribute("data-tilda-mask", e.li_datemask), a.setAttribute("data-tilda-dateunvailable", s), a.id = e.li_type + "-" + e.lid, i.insertAdjacentElement("beforeend", a);
  var l, _ = '<svg class="t-datepicker__icon" fill="' + (n.inputsstyle ? n.inputelscolor : o.color) + '" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 69.5 76.2" style="width:25px;"><path d="M9.6 42.9H21V31.6H9.6v11.3zm3-8.3H18v5.3h-5.3v-5.3zm16.5 8.3h11.3V31.6H29.1v11.3zm3-8.3h5.3v5.3h-5.3v-5.3zM48 42.9h11.3V31.6H48v11.3zm3-8.3h5.3v5.3H51v-5.3zM9.6 62H21V50.6H9.6V62zm3-8.4H18V59h-5.3v-5.4zM29.1 62h11.3V50.6H29.1V62zm3-8.4h5.3V59h-5.3v-5.4zM48 62h11.3V50.6H48V62zm3-8.4h5.3V59H51v-5.4z"></path><path d="M59.7 6.8V5.3c0-2.9-2.4-5.3-5.3-5.3s-5.3 2.4-5.3 5.3v1.5H40V5.3C40 2.4 37.6 0 34.7 0s-5.3 2.4-5.3 5.3v1.5h-9.1V5.3C20.3 2.4 18 0 15 0c-2.9 0-5.3 2.4-5.3 5.3v1.5H0v69.5h69.5V6.8h-9.8zm-7.6-1.5c0-1.3 1-2.3 2.3-2.3s2.3 1 2.3 2.3v7.1c0 1.3-1 2.3-2.3 2.3s-2.3-1-2.3-2.3V5.3zm-19.7 0c0-1.3 1-2.3 2.3-2.3S37 4 37 5.3v7.1c0 1.3-1 2.3-2.3 2.3s-2.3-1-2.3-2.3V5.3zm-19.6 0C12.8 4 13.8 3 15 3c1.3 0 2.3 1 2.3 2.3v7.1c0 1.3-1 2.3-2.3 2.3-1.3 0-2.3-1-2.3-2.3V5.3zm53.7 67.9H3V9.8h6.8v2.6c0 2.9 2.4 5.3 5.3 5.3s5.3-2.4 5.3-5.3V9.8h9.1v2.6c0 2.9 2.4 5.3 5.3 5.3s5.3-2.4 5.3-5.3V9.8h9.1v2.6c0 2.9 2.4 5.3 5.3 5.3s5.3-2.4 5.3-5.3V9.8h6.8l-.1 63.4z"></path></svg>';
  return i.insertAdjacentHTML("beforeend", _), t_zeroForms__addResource({
    recId: t,
...
function t_zeroForms__createQuantityField(t, e, r, o) {
  ...
  return t_zeroForms__appendMainSettingToField(s, o, "number", ["t-input", "t-inputquantity"]), t_zeroForms__appendAttributes(s, o), t_zeroForms__appendStylesToField(s, e), s.value = t.li_value || "", s.id = t.li_type + "-" + t.lid, s.setAttribute("data-tilda-rule", "number"), n.insertAdjacentElement("beforeend", i), n.insertAdjacentElement("beforeend", s), n.insertAdjacentElement("beforeend", a), n
}
...
function t_zeroForms__createQuantityRange(t, e, r, o, n) {
  var i = t_zeroForms__createWrapper("t-range__wrapper"),
    a = document.createElement("input");
  t_zeroForms__appendMainSettingToField(a, n, "range", "t-range"), o.inputelscolor && a.setAttribute("data-range-color", o.inputelscolor), a.min = t_zeroForms__validateNumericValue(e.li_vmin, "0"), a.max = t_zeroForms__validateNumericValue(e.li_vmax, "10"), a.step = t_zeroForms__validateNumericValue(e.li_step, "1"), a.value = t_zeroForms__validateNumericValue(e.li_value), a.style.width = "100%", e.li_title || e.li_subtitle ? a.id = e.li_type + "-" + e.lid : a.ariaLabel = "range", i.insertAdjacentElement("beforeend", a);
  var s = document.createElement("div");
  s.classList.add("t-range__value-txt"), s.classList.add("t-descr"), s.classList.add("t-descr_xxs"), s.style.display = "none", i.insertAdjacentElement("beforeend", s);
  ...
  return l.insertAdjacentElement("beforeend", _), l.insertAdjacentElement("beforeend", d), i.insertAdjacentElement("beforeend", l), t_zeroForms__addResource({
    recId: t,
...
function t_zeroForms__createRangeField(t, e, r) {
  ...
  return o.classList.add("t-range__interval-txt"), o.classList.add("t-range__interval-txt_" + t), o.classList.add("t-descr"), o.classList.add("t-descr_xxs"), e && (o.style.color = e), o.innerHTML = r, o
}

function t_zeroForms__createCalculation(t, e, r, o, n) {
  var i = document.createDocumentFragment(),
    a = document.createElement("input");
  t_zeroForms__appendMainSettingToField(a, o, "hidden", "t-calc__hiddeninput"), a.tabIndex = -1, a.value = "0", i.appendChild(a);
  var s = t_zeroForms__createWrapper(["t-calc__wrapper", "t-name", "t-name_md"]);
  s.style.color = r.color, s.style.fontFamily = n.fontFamily, s.style.fontSize = r.fontSize, s.style.fontWeight = r.fontWeight, t_zeroForms__createCalcTextField(e.li_prefix, "prefix", s);
  var l = document.createElement("span");
  if (l.classList.add("t-calc"), l.setAttribute("data-calc-expr", t_zeroForms__removeStringQuotes(e.li_expr)), l.textContent = "0", s.insertAdjacentElement("beforeend", l), t_zeroForms__createCalcTextField(e.li_postfix, "postfix", s), t_zeroForms__addResource({
      recId: t,
      id: "t-zero-calc",
      path: "tilda-calc-1.0.min.js",
      type: "script"
    }), i.appendChild(s), "y" !== e.li_addtocart) return i;
  if (e.li_prod_title) {
...
function t_zeroForms__createCalcTextField(t, e, r) {
  if (t) {
    ...
    o.classList.add("t-calc__" + e + "-text"), o.innerHTML = t, r.insertAdjacentElement("beforeend", o)
  }
}
...
function t_zeroForms__createFormButton(t, e, r, o) {
  ...
  var a = o.buttontitle;
  return a && (i.innerHTML = a), t_zeroForms__setBtnInlineStyles(o, i), n.insertAdjacentElement("beforeend", i), "zero" === window.tildamode || "edit" === window.tildamode ? (window.tn && window.tn.curResolution < 640 && (i.style.whiteSpace = "normal"), t_zeroForms__generateBtnStyles(i, t, r, o, e)) : t_zeroForms__onRender(e, !0, (function() {
...
function t_zeroForms__generateBtnStyles(t, e, r, o, n) {
  ...
  l && (c += ", ", c += d + ".uploadcare--widget__button.uploadcare--widget__button_type_open"), _ && (c += ", ", c += d + ".t-upwidget-container__button");
  var m, p = c + "{" + a + (s ? "transition: 0.3s ease all;" : "") + "}";
  u && (p += u, t.classList.add("tn-form__submit-gradient"), l && (p += d + ".uploadcare--widget__button.uploadcare--widget__button_type_open ", p += "{background-image: " + o.buttonbgcolor + "; background-color: transparent;}"), _ && (p += d + ".t-upwidget-container__button ", p += "{background-image: " + o.buttonbgcolor + "; background-color: transparent;}"));
  var f = "t-zero-form-btn-styles-" + r + "-" + e,
    b = document.getElementById(f);
  if (b && b.parentElement && b.parentElement.removeChild(b), t_zeroForms__addInlineTag({
      tag: "style",
      id: f,
      content: p,
      zeroForm: n
    ...
    z && z.parentElement && z.parentElement.removeChild(z), t_zeroForms__addInlineTag({
      tag: "style",
      id: F,
      content: v,
      zeroForm: n
...
function t_zeroForms__generateButtonHoverStyles(t) {
  ...
  (t.buttonhovershadowsize || t.buttonshadowopacity) && (e["box-shadow"] = "0px 0px " + (t.buttonhovershadowsize ? t.buttonhovershadowsize + "px" : "10px") + " 0px rgba(0, 0, 0, " + (t.buttonshadowopacity ? t.buttonshadowopacity / 100 : "0.3") + ")");
  var r = "";
...
function t_zeroForms__createErrorBox(t, e, r) {
  ...
  var n = document.createElement("div");
  n.classList.add("js-errorbox-all"), n.classList.add("t-form__errorbox-wrapper"), n.style.display = "none", o.insertAdjacentElement("beforeend", n);
  var i = document.createElement("div"),
    a;
  i.classList.add("t-form__errorbox-text"), i.classList.add("t-text_xs"), i.classList.add("t-text"), ["all", "req", "email", "name", "phone", "string"].forEach((function(t) {
    var r = document.createElement("p");
    r.classList.add("t-form__errorbox-item"), r.classList.add("js-rule-error"), r.classList.add("js-rule-error-" + t), "all" !== t && "string" !== t && (r.textContent = e["formerr" + t]), i.insertAdjacentElement("beforeend", r)
  })), n.insertAdjacentElement("beforeend", i);
  var s = document.createElement("div");
  return s.classList.add("tn-form__errorbox-close"), s.classList.add("js-errorbox-close"), s.insertAdjacentElement("beforeend", t_zeroForms__createErrorBoxBtn("left")), s.insertAdjacentElement("beforeend", t_zeroForms__createErrorBoxBtn("right")), n.insertAdjacentElement("beforeend", s), document.removeEventListener("click", t_zeroForms__initErrorBoxClose), document.addEventListener("click", t_zeroForms__initErrorBoxClose), t_zeroForms__addResource({
    recId: t,
...
function t_zeroForms__getBottomText(t, e, r, o, n) {
  ...
  if (["cb", "cbx"].some((function(t) {
    ...
    }, "checkbox", "t-checkbox"), l.setAttribute("data-tilda-req", "1"), "cbx" === e.formbottomcb && (l.checked = !0), s.insertAdjacentElement("beforeend", l);
    var d = t_zeroForms__createIndicator("checkbox", e.inputelscolor, !1);
    d.style.width = "15px", d.style.height = "15px", d.style.marginRight = "5px", s.insertAdjacentElement("beforeend", d);
    ...
    return t_zeroForms__addInlineTag({
      tag: "style",
...
function t_zeroForms__animateInputs(t, e, r, o) {
  ...
  if (e.inputcolor) {
    var i, a = [".t-input-group:not(.t-input-group_da):not(.t-input-group_ph):not(.t-input-group_uw):not(.t-input-group_ri):not(.t-input-group_cb):not(.t-input-group_rg) .t-input", ".t-datepicker__wrapper", ".t-input__vis-ph"].map((function(t) {
      return n + " " + t
    })).join(", ");
    t_zeroForms__addInlineTag({
      tag: "style",
  ...
  var s = (Number(e.inputheight) - Number(e.inputfontsize)) / 2,
    ...
    _ = n + ".t-input:not(.t-inputquantity):not(.t-input-phonemask__wrap):not(.t-input-phonemask):not(.t-input__own-answer)",
    d;
  if (Array.prototype.slice.call(document.querySelectorAll(_)).forEach((function(t) {
      ...
      if (r) {
        var o = document.createElement("div");
        o.classList.add("t-input__vis-ph"), s && (o.style.top = s + "px"), l && (o.style.fontWeight = l), e.inputfontsize && (o.style.fontSize = e.inputfontsize + "px", o.style.height = parseInt(e.inputfontsize, 10) + 1 + "px"), o.innerHTML = r, t.insertAdjacentElement("afterend", o), t.removeAttribute("placeholder")
      }
...
function t_zeroForms__addResource(t) {
  ...
  if (!document.getElementById(r)) {
    ...
    c.id = r, "script" === n ? (c.src = d + "/js/" + o, c.async = !0) : "link" === n && (c.href = d + "/css/" + o, c.rel = "stylesheet"), c.addEventListener("error", (function() {
      t_zeroForms__onFuncLoad("t_fallback__reloadSRC", (function() {
        t_fallback__reloadSRC(c)
      })), c.setAttribute("data-loaded", "true")
    })), c.addEventListener("load", (function() {
      c.setAttribute("data-loaded", "true")
    })), t_zeroForms__addResourceToQueue(i, c), document.head.insertAdjacentElement("beforeend", c)
  }
}
...
function t_zeroForms__addInlineTag(t) {
  ...
  if (!document.getElementById(r) && o) {
    var a = document.createElement(i),
      s;
    a.id = r, a.textContent = o, (n ? n.querySelector(".tn-atom") : document.head).insertAdjacentElement("beforeend", a)
  }
}

function t_zeroForms__isInWhiteList(t) {
  var e;
  if (t && t_zeroForms__isTeam() && !["tilda-zero-form-errorbox.min.css", "tilda-zero-form-horizontal.min.css", "tilda-phone-mask-1.1.min.js", "tilda-date-picker-1.0.min.css", "tilda-date-picker-1.0.min.js", "tilda-calc-1.0.min.js", "tilda-upwidget-1.1.min.js", "uploadcare-3.x.full.min.js", "uploadcare-3.x.min.js", "tilda-range-1.0.min.js", "tilda-range-1.0.min.css", "tilda-img-select-1.0.min.js", "tilda-img-select-1.0.min.css"].includes(t)) throw new Error(t + " is not allowed. Make sure the file is included in form export dependencies and then add it to the white list.")
}
...
function t_zeroForms__appendMainSettingToField(t, e, r, o) {
  ...
  void 0 === i && (i = "text"), r && "select" !== r && (t.type = i), t.name = e.name || "", o || t.classList.add("t-input"), o && ("object" == typeof o ? o.forEach((function(e) {
    t.classList.add(e)
...
function t_zeroForms__isRecordHidden(t) {
  return !!t && ("yes" === t.getAttribute("data-connect-with-tab") && ["t397__off", "t395__off", "t400__off"].some((function(e) {
...
function t_zeroForms__placeFormIntoColumns(t) {
  ...
  if ("h" !== t_zeroForms__getFieldValue(t, "data-field", "inputpos")) {
    ...
    if (r) {
      ...
      if (0 !== o.length) {
        r.classList.add("t-form__inputsbox_flex"), r.classList.add("t-form__inputsbox_inrow"), Array.prototype.forEach.call(o, (function(t) {
          ...
          r && t.classList.contains("t-input-group_widthdef") && t.classList.contains("t-input-group_inrow-withsibling") && r.classList.contains("t-input-group_inonerow") && !r.classList.contains("t-input-group_inrow") && (r.classList.add("t-input-group_widthdef"), r.classList.contains("t-input-group_inrow-withsibling") || r.classList.add("t-input-group_inrow-last"), r.classList.contains("t-input-group_inrow") && t.classList.add("t-input-group_inrow-last"))
        }));
...
function t396_zeroForms__getDefaultOption(t) {
  return t ? ["sb", "ri", "rd"].includes(t.li_type) ? t.li_defselitem || null : ["cb"].includes(t.li_type) ? t.li_checked || null : ["qn", "rg"].includes(t.li_type) ? t.li_value || null : void 0 : null
}

function t396_zeroForms__getProjectId() {
  return "zero" === t_zeroForms__getTildaMode() ? window.projectid : document.getElementById("allrecords").getAttribute("data-tilda-project-id");
  var t, e
}
...
function t_zeroForms__addResourceToQueue(t, e) {
  var r = 5e3;
  window.t_zeroForms__resourcesQueue[t] = window.t_zeroForms__resourcesQueue[t] || [], window.t_zeroForms__resourcesQueue[t].push(new Promise((function(t, o) {
...
window.t_zeroForms__formIdMap = null, window.t_zeroForms__resourcesQueue = {}, t_zeroForms__onReady((function() {
  var t = document.getElementById("allrecords");
  if (t) {
